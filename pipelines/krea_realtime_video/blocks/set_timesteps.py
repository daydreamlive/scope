...
class SetTimestepsBlock(ModularPipelineBlocks):
    """Base Set Timesteps block that configures denoising steps across pipelines."""
    ...
    def description(self) -> str:
        return "Base Set Timesteps block that configures denoising steps based on scheduler"
    ...
    def __call__(self, components, state: PipelineState) -> PipelineState:
        ...
        # TODO: Move the actual set_timestamps logic from the KreaSchedulerWrapper here
