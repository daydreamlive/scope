...
class AfterDecodeBlock(ModularPipelineBlocks):
    ...
    def __call__(self, components, state: PipelineState) -> PipelineState:
        ...
        components.generator.decoded_frame_buffer = torch.cat(
            [
                components.generator.decoded_frame_buffer,
                block_state.output.to(
                    components.generator.decoded_frame_buffer.device,
                    components.generator.decoded_frame_buffer.dtype,
                ),
            ],
            dim=1,
        )[:, -components.generator.decoded_frame_buffer_max_size :]
