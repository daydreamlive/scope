...
class WanVAEWrapper(torch.nn.Module):
    def __init__(self, model_name: str = "Wan2.1-T2V-1.3B", model_dir: str | None = None, vae_path: str | None = None):
        super().__init__()
    ...
    def __init__(
        ...
        if is_causal:
            if generator_path:
                ...
                freqs_shape = self.model.freqs.shape if hasattr(self.model, 'freqs') else None
                ...
                if freqs_shape is not None and hasattr(self.model, 'freqs'):
                    ...
                    from .modules.causal_model import rope_params
        ...
        # Scheduler will be set externally by pipeline
        self.scheduler = None
