...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def _prepare_blockwise_causal_attn_mask(
        ...
        if not dist.is_initialized() or dist.get_rank() == 0:
            ...
            logger.debug(f"Block mask: {block_mask}")
    ...
    def _forward_inference(
        ...
        Args:
            ...
            controlnet_states (tuple[Tensor], *optional*):
                Optional tuple of ControlNet states for transformer blocks
            controlnet_weight (float, *optional*):
                Strength of ControlNet influence when controlnet_states is provided
            controlnet_stride (int, *optional*):
                Apply ControlNet states every Nth transformer block
