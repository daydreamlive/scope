...
from .permanent_merge_lora import PermanentMergeLoRAManager
from .peft_lora import PeftLoRAManager
from .gpu_reconstruct_lora import GpuReconstructLoRAManager
from .cuda_graph_recapture_lora import CudaGraphRecaptureLoRAManager
...
class LoRAManager:
    ...
    @staticmethod
    def load_adapter(model, lora_path: str, strength: float = 1.0, merge_mode: str = None) -> str:
        """
