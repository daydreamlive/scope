...
export const PARAMETER_METADATA: Record<string, ParameterMetadata> = {
  ...
  loraMergeStrategy: {
    label: "LoRA Strategy:",
    tooltip:
      "LoRA merge strategy affects performance and update speed. Permanent Merge: 9.15 FPS, no runtime updates, 68s init. Runtime PEFT: 4.34 FPS, instant updates, 2s init. GPU Reconstruct: 10.3 FPS, 60s updates, 130s init.",
  },
};
