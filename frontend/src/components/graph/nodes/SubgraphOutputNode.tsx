...
function EditableLabel({
  ...
  if (!editing) {
    return (
      <span
        className="text-[10px] text-[#999] select-none whitespace-nowrap pl-1.5 cursor-text"
        onDoubleClick={e => {
          e.stopPropagation();
          setDraft(value);
          setEditing(true);
  ...
  return (
    <input
      ref={inputRef}
      className="text-[10px] text-[#ccc] bg-[#333] border border-[#555] rounded px-0.5 outline-none w-16 ml-1.5"
      value={draft}
