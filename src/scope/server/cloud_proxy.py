...
async def get_hardware_info_from_cloud(
    ...
    virtualcam_available: bool = False,
) -> HardwareInfoResponse:
    """Fetch hardware info from cloud and return with local output availability.

    Spout/NDI/VirtualCam availability is taken from the caller (local) because
    output sink frames flow through the local backend.
    """
    ...
    return HardwareInfoResponse(
        ...
        virtualcam_available=virtualcam_available,
    )
