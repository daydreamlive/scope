...
class FrameProcessor:
    ...
    def start(self):
        ...
        logger.info(f"FrameProcessor started with {len(self.pipeline_ids)} pipeline(s): {self.pipeline_ids}")
    ...
    def _setup_pipeline_chain_sync(self):
        ...
        logger.info(f"Created pipeline chain with {len(self.pipeline_processors)} processors")
