...
class VaceBlock(CausalWanAttentionBlock):
    ...
    def forward_vace(self, c, x, e0, freqs_cos, freqs_sin, context, empty_cache):
        ...
        Args:
            ...
            empty_cache: Pre-allocated empty KV cache tensor [B, 0, heads, head_dim].
...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def _embed_vace_context(self, vace_context, seq_len):
        ...
        Args:
            ...
            seq_len: Target sequence length to pad to (from main model's patch embedding).

        Returns:
            Embedded and padded VACE context tensor [B_vace, seq_len, dim].
        """
