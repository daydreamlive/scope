...
CONFIG = {
    ...
    # ===== INPUT PATHS =====
    # R2V: List of reference image paths (used on first chunk only)
    "ref_images": [
        "frontend/public/assets/example.png",  # Relative to project root or absolute path
    ],
    # Depth: Path to depth map video (grayscale or RGB, will be converted)
    "depth_video": "vace_tests/control_frames_depth.mp4",  # Your depth video here
    # Inpainting: Input video and mask video paths
    "input_video": "frontend/public/assets/test.mp4",  # Relative to project root
    "mask_video": "vace_tests/circle_mask.mp4",  # Your mask video here
    ...
    # ===== OUTPUT =====
    "output_dir": "vace_tests/unified",  # Relative to this script
}
