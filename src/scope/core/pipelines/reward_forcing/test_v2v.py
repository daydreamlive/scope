...
# RewardForcing uses num_frame_per_block=3 and vae_temporal_downsample_factor=4
...
# input_video is a CTHW tensor, unsqueeze to 1CTHW for batch dimension
default_video_path = (
...
for i in range(num_chunks):
    ...
    start = time.time()
    # output is THWC
    output = pipeline(video=chunk, prompts=prompts, noise_scale=0.7)
