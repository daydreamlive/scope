...
# SetupCachesBlock: Sets up caches (may reset current_start_frame when prompts change)
# AutoPreprocessVideoBlock: Routes to video preprocessing when 'video' input provided (runs after SetupCachesBlock)
