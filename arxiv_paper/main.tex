...
Key design decisions include: zero-initialized hint projections enabling safe composition with LoRA and quantization; implicit mode detection from provided inputs; crop-to-fill resizing to avoid padding artifacts; and cached hint computation where reference hints are computed once and reused across chunks.
